            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <a wire:click='createColorCategory()' class="plus-icon">
                        ...
                        <table class="table table-striped nowrap" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th style="width: 100px">Kleuren</th>
                                <th style="width: 100px">Bewerken</th>
                                <th style="width: 100px">Verwijderen</th>
                            </tr>
                            </thead>
                            <tbody wire:sortable="updateColorCategoryOrder">
                            @foreach($this->colorCategories as $item)
                                <tr wire:sortable.item="{{$item->id}}" wire:key="project_{{$item->id}}">
                                    ...
                                    <td style="max-width: 175px;">
                                        <button wire:click="color({{$item->id}})" class="btn btn-secondary btn-sm">Kleuren</button>
                                    </td>
                                    <td style="max-width: 60px;">
                                        <button wire:click="editColorCategory({{$item->id}})" class="btn btn-primary btn-sm">Bewerken</button>
                                    </td>
                                    <td style="max-width: 60px">
                                        <button wire:click="deleteColorCategory({{$item->id}})" class="btn btn-danger btn-sm">Verwijderen</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
